...
C_SRCS += \
../Sources/1.MCAL/Interrupts/EXTINT.c \
../Sources/1.MCAL/Interrupts/GINT.c 

OBJS += \
./Sources/1.MCAL/Interrupts/EXTINT.o \
./Sources/1.MCAL/Interrupts/GINT.o 

C_DEPS += \
./Sources/1.MCAL/Interrupts/EXTINT.d \
./Sources/1.MCAL/Interrupts/GINT.d 


# Each subdirectory must supply rules for building sources it contributes
Sources/1.MCAL/Interrupts/%.o: ../Sources/1.MCAL/Interrupts/%.c
	@echo 'Building file: $<'
